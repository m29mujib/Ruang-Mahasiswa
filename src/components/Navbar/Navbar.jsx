   ...
   return(
      <div className={`w-full ${styles.navbar}`}>
        <div className={styles.left}>
            <h2 className="text-xl text-slate-900 font-bold">Selamat Datang, Mujib..</h2>
            <p className="text-sm font-bold text-green-500">Mau cari informasi akademik apa hari ini.....</p>
        </div>
        <div className={styles.right}>
            ...
            <div>
               <p className="text-center text-xs font-semibold">Mujib MA</p>
